...
export default function DaycarePage() {
  return (
    <VerticalPageShell
      ...
      heroBody="Sam is an AI assistant trained on your daycare. It handles tuition questions, waitlist asks, and tour bookings on your website — even on Saturday morning — so your director isn't fielding the same five calls every day."
      ...
      chatGreeting="Hi! I'm Sam, your assistant for Bright Horizons Daycare. How can I help today?"
      ...
      outcomes={[
        {
          ...
          body: 'Hours, tuition, age bands, openings, what to bring on day one — Sam handles them all without staff time.',
        },
        {
          num: '24/7',
          title: 'Available when parents are looking',
          body: "Most parents research childcare at night after their kids go to bed. Sam answers them when you can't.",
        },
        {
          num: '1 wk',
          title: 'Live on your site',
          body: "Send us your handbook, FAQ, and tuition sheet. We train Sam, you review, and it's live in five business days.",
        },
      ]}
      featureHeading={
        <>
      ...
      featureBody="Tuition by age group. Sibling discounts. Waitlist status. What's included in lunch. When you're closed for holidays. Whether you take state vouchers. Sam knows all of it because we trained it on your handbook — and it never makes anything up."
      featureBrandTitle="Bright Horizons Daycare"
      featureMiniMessages={[
        { role: 'user', text: 'Tuition?' },
        {
          role: 'bot',
          text: 'Sam quotes the right age band, mentions sibling discount, and offers to start a waitlist application.',
        },
        { role: 'user', text: 'Tour?' },
      ]}
      qbankHeading={
      ...
      qbank={[
        {
          ...
          a: 'Sam quotes the right age band, mentions sibling discount, and offers to start a waitlist application.',
        },
        {
          q: 'Do you have any openings for September?',
          a: 'Sam checks current waitlist status by classroom and offers to add the family with a refundable hold.',
        },
        {
          q: 'What time do you open and close?',
          a: 'Sam pulls hours from your handbook — including early-care and late-pickup options if you offer them.',
        },
        {
          q: 'Is lunch included? My son has a peanut allergy.',
          a: "Sam confirms what's included, your nut-free policy, and offers to flag the allergy for the director's review.",
        },
        {
          q: 'Do you accept the state subsidy program?',
          a: 'Sam answers based on whether you participate, and routes the family to the right paperwork.',
        },
        {
          q: 'Can we schedule a tour this Saturday?',
          a: 'Sam offers your tour slots (Tuesday/Thursday 10am, or by appointment) and books it directly into your calendar.',
        },
      ]}
